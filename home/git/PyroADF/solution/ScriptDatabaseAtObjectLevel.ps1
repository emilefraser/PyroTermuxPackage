...
$Server = 'PhilFactorTestServer' #the name of the server
$Instance = 'sql2008'            #The server instance
...
$DatabaseScriptPath = "$($env:HOMEDRIVE)$($env:HOMEPATH)\Documents\GitHub\$($Database)"
