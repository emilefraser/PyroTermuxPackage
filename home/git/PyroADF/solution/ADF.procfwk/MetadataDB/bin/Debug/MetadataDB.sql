...
GO
PRINT N'Dropping [procfwk].[MessagePreferenceValue]...';


GO
ALTER TABLE [procfwk].[Recipients] DROP CONSTRAINT [MessagePreferenceValue];
...
GO
ALTER TABLE [procfwk].[Recipients] WITH NOCHECK
...
GO
ALTER TABLE [procfwk].[Recipients] WITH CHECK CHECK CONSTRAINT [MessagePreferenceValue];
